...
/**
 * A context used during evaluation of EL expressions. Can be used to register functions,
 * store input variables or intermediary results.
 * @author laurent
 */
public class EvaluationContext {
   ...
   /**
    * Retrieve a registered variable by it's name.
   ...
   /**
    * Retrieve a registered function by it's name.
