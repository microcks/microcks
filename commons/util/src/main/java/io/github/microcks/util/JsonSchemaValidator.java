...
/**
 * Helper class for validating Json objects against their Json schema. Supported
 * version
...
public class JsonSchemaValidator {
   ...
   * is respectful of Json schema spec semantics regarding additional or unknown
   * attributes: schema must
  ...
  /**
   * Extract a Json SchemaNode from Jackson representation. Dependencies can be
   * loaded using a namespace definition.
   * See
   * https://github.com/java-json-tools/json-schema-validator/blob/main/src/main/java/com/github/fge/jsonschema/examples/Example5.java
