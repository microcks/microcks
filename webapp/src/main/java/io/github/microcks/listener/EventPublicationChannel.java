 ...
 * @author laurent
 */
public interface EventPublicationChannel {
   ...
   /**
    * Send an asynchronous API trigger command.
    * @param command The event to send or propagate via this channel.
    * @throws Exception if the case event cannot be sent
    */
   void sendAsyncAPITriggerCommand(AsyncAPITriggerCommand command) throws Exception;
}
