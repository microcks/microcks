 ...
 * This will allow different implementations depending on where and how the file path is encoded into
 * base repository URL.
 * @author laurent
 */
public interface RelativeReferenceURLBuilder {
   ...
   /**
    * Returns the name of the file denoted by <code>baseRepositoryUrl</code>. Addiotional headers
    * (like download headers) can be optionally provided.
    ...
    * @param referencePath A path like <code>my-file.yaml</code> or <code>../my-file.yaml</code> to get reference from base
