...
public class ImportExportService {
   ...
   public String exportRepository(List<String> ids, String format){
      ...
      List<com.github.lbroudoux.microcks.domain.Service> services = serviceRepository.findByIdIn(ids);
      try{
   ...
   public static class ImportExportModel {
      private List<com.github.lbroudoux.microcks.domain.Service> services;
