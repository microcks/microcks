...
public class PostmanCollectionImporterTest {
   ...
   @Test
   public void testSimpleProjectImportV1() {
      PostmanCollectionImporter importer = null;
      try {
         importer = new PostmanCollectionImporter("target/test-classes/com/github/lbroudoux/microcks/util/postman/PetstoreAPI-collection-v1.json");
