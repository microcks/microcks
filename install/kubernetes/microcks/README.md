...
| `<root>`   | `commonAffinities`              | **Optional**. Defines the affinities that will be added to all kubernetes deployments (Default to `empty`)                                                                                                                                                                                                          |
| `<root>`   | `commonTolerations`         | **Optional**. Defines the list of tolerations that will be added to all kubernetes deployments (Default to `empty`)                                                                                                                                                                                                        |
