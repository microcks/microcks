...
/**
 * This is a test case for AmazonSNSProducerManager.
 * @author laurent
 */
class AmazonSNSProducerManagerTest {
   ...
   void testGetTopicName() {
      ...
      String queueName = producerManager.getTopicName(definition, eventMessage);
      assertEquals("StreetlightsAPI-010-receiveLightMeasurement", queueName);
   }

   @Test
   void testTopicNameWithPart() {
      AmazonSNSProducerManager producerManager = new AmazonSNSProducerManager();
